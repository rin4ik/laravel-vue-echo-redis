...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    sendEvent: function sendEvent() {
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.post('http://localhost:8000/api/order-updated');
    }
  },
  mounted: function mounted() {
    var _this = this;

    this.$echo.channel('orders').listen('.order.updated', function (e) {
      _this.events.unshift(e);
    });
  }
});
    ...
    _c("div", { staticClass: "header-text hidden-xs" }, [
      _c(
        ...
        [
          ...
          _c(
            "button",
            { staticClass: "btn btn-primary", on: { click: _vm.sendEvent } },
            [_vm._v("Send Event")]
          ),
          _vm._v(" "),
          _c("br"),
...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("h2", [_c("span", [_vm._v("Hi, Guest!")])])
  }
]
